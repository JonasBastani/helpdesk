    ...
    -->
      <<div class="sidebar-wrapper">
        ...
        <ul class="nav">
          ...
          <li id ="li_usuarios"class="active "> 
            <a  id="a_usuarios">
...
<!-- Corpo -->
    ...
    <div id="div_usuarios" class="content ">
      <div class="usuario" >
        <ul class="nav nav-tabs">
          <li class="active nav-item">
              <a class="active nav-link " href="#usuarios_cadastrados" role="tab" data-toggle="tab">Usuários cadastrados</a>
          </li>
        </ul>

  		</br>
    
    <button  id="add_user" class="btn btn-primary">Adicionar Usuário</button>

    <div class="float-right">

      <a id="reload_datatable"><i class="btn tim-icons icon-refresh-02"> </i></a>
    </div>
    ...
    <div class="tab-content">
      ...
      <div id="usuarios_cadastrados" class="tab-pane nav-item active" >
        ...
        <table class=" table-active table-hover tablesorter" id="dt_user">
          <thead class="text-white">
            <tr>

              <th scope="col" title="Clique para ordenar por ID" name="id" id="id">Id</th>
              <th scope="col" title="Clique para ordenar por Nome" name="nome" id="nome">Nome</th>
              <th scope="col" class="no-sort" name="email" id="email2">E-mail</th>
              <th scope="col" title="Clique para ordenar por Nível de Acesso" name="acesso" id="acesso">Nível de Acesso</th>
              <th scope="col" title="Clique para ordenar por Status" name="situacao" id="situacao">Status</th>
              <th scope="col" class="no-sort dt-center" name="acoes" id="acoes">Ações</th>
            </tr>
          </thead>
