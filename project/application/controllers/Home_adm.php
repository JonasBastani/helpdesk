...
class Home_adm extends CI_Controller {
	...
	public function ajax_desative_user_data()
	{
		if(!$this->input->is_ajax_request())
		{
			exit("Voce nao tem permissao para acessar este ambiente!");
		...
		$user_id = $this->input->post("user_id");
		$this->users_model->desative_active($user_id, $data);

		echo json_encode($json);

	}

		public function ajax_active_user_data()
	{
		if(!$this->input->is_ajax_request())
		{
			exit("Voce nao tem permissao para acessar este ambiente!");
...
public function ajax_contesta_chamado()
		...
		foreach ($chamados as $chamado) {
			...
			if ($chamado->status == 1) {
				...
				$row[] = '<div  class="acoes form-row">
							...
							<a  style="cursor: pointer;"  class="btn-edit-chamado" title="Clique para editar" id="btn-edit-chamado" chamado_id="'.$chamado->chamado_id.'"><p><i class="tim-icons icon-pencil"></i></p></a>&nbsp;&nbsp;
							<a style="cursor: pointer;" class="btn-andamento_chamado" title="Clique para colocar chamado em andamento" chamado_id="'.$chamado->chamado_id.'"><p><i class="tim-icons icon-triangle-right-17"></i></p></a>
				...
				$row[] = '<div class="acoes form-row">
						<a  style="cursor: pointer;"  class="btn-ver-chamado" title="Clique para ver detalhes" id="btn-visualizar-chamado" chamado_id="'.$chamado->chamado_id.'"><p><i class="tim-icons icon-paper"></i></p></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a style="cursor: pointer;" class="btn-concluir_chamado" title="Clique para marcar o chamado como concluído" chamado_id="'.$chamado->chamado_id.'"><p><i class="tim-icons icon-check-2"></i></p></a>
						</div>';
			}
				...
				$row[] = '<div class="acoes form-row">
						<a  style="cursor: pointer;"  class="btn-ver-chamado" title="Clique para ver detalhes" id="btn-visualizar-chamado" chamado_id="'.$chamado->chamado_id.'"><p><i class="tim-icons icon-paper"></i></p></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a style="cursor: pointer;" class="btn-retorna_andamento_chamado" title="Clique para retornar o chamado para em andamento" chamado_id="'.$chamado->chamado_id.'"><p><i class="tim-icons icon-double-left"></i></p></a>
						</div>';
			}
				...
				$row[] =  '<div  class="acoes form-row">
							<a  style="cursor: pointer;"  class="btn-ver-chamado" title="Clique para ver detalhes" id="btn-visualizar-chamado" chamado_id="'.$chamado->chamado_id.'"><p><i class="tim-icons icon-paper"></i></p></a>&nbsp;&nbsp;
							<a  style="cursor: pointer;"  class="btn-ver-contesta" title="Clique para ver a contestação" id="btn-edit-chamado" chamado_id="'.$chamado->chamado_id.'"><p><i class="tim-icons icon-alert-circle-exc"></i></p></a>&nbsp;&nbsp;
							<a style="cursor: pointer;" class="btn-andamento_chamado" title="Clique para colocar chamado em andamento" chamado_id="'.$chamado->chamado_id.'"><p><i class="tim-icons icon-triangle-right-17"></i></p></a>
	...
	public function ajax_get_chamado_detalhes()
	{
		...
		if ($data["status"] == 1) {
			...
			$json["input"]["status_list"] = "Fechado";
		}
	...
	public function ajax_andamento_chamado()
	{
		if(!$this->input->is_ajax_request())
		{
			exit("Voce nao tem permissao para acessar este ambiente!");
